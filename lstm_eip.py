...
Original file is located at
    https://colab.research.google.com/drive/1v3TBYquLWbKWr00VmO4u4MpiampF6P5L
"""
...
for i, batch in enumerate(data):
  if i % 5 < 3:    
    train_l.append(batch) 
  elif i % 5 == 3: 
    valid_l.append(batch) 
  else:            
    test_l.append(batch) 
...
text_field.build_vocab(train, vectors = custom_embeddings)
...
train_model(lstm_model, torchtext_train_dataloader, torchtext_valid_dataloader, num_epochs=35, learning_rate=0.001)


import pickle
filehandler = open(b"model","wb")
